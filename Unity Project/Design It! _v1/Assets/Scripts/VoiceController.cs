...
namespace Oculus.Voice
{
    public class VoiceController : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            appVoiceExperience.events.OnFullTranscription.AddListener(OnRequestFullTranscript);
        ...
        private void OnDisable()
        {
            ...
            appVoiceExperience.events.OnFullTranscription.RemoveListener(OnRequestFullTranscript);
